...
resumeForm.addEventListener('submit', (event: Event) => {
    ...
    const experience = (document.getElementById('skills') as HTMLTextAreaElement).value; // Corrected assignment
    const skills = (document.getElementById('experience') as HTMLTextAreaElement).value; // Corrected assignment
...
function generateResumeHTML(data: {name: string, email: string, phone: string, education: string, experience: string, skills: string}): string {
    return `
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (username) {
        ...
        if (savedResumeData) {
            ...
            (document.getElementById('skills') as HTMLTextAreaElement).value = resumeData.experience; // Corrected assignment
            (document.getElementById('experience') as HTMLTextAreaElement).value = resumeData.skills; // Corrected assignment
        }
    }
});
